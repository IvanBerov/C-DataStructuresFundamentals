namespace _01.Inventory
{
    ...
    public class Inventory : IHolder
    {
        ...
        // O(n)
        // returns all the weapons inside a List. If there are none – return an empty list.
        ...
        // O(n)
        // empties the ammunition of all weapons from the given category.
        ...
        // O(n^2)??
        // removes all heavy weapons and returns their count
