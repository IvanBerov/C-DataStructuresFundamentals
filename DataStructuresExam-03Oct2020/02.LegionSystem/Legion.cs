...
namespace _02.LegionSystem
{
    ...
    public class Legion : IArmy
    {
        ...
        // O(n*logN)
        // returns the enemy with the given attack speed, otherwise returns null
        ...
        // O(n ^ 2) ?
        // Returns the whole legion as an array ordered by their health in descending.
        // If the legion contains no enemies return an empty array
        public IEnemy[] GetOrderedByHealth()
        {
            var byHealthSet = new OrderedBag<IEnemy>(this._enemies, CompareByHealth);

            return byHealthSet.ToArray();
        }

        // O(n)
        // Retrieves all enemies that are faster than the given attack speed (not inclusive),
